...
public class RegexUtils {
    ...
    public static List<String> getMatches(String regex, CharSequence input) {
        ...
        if (StringUtils.isEmpty(input) || StringUtils.isEmpty(input)) return matches;
    ...
    public static List<String> matchParts(String str, String regex) {
     ...
     * @return
     */
    public static double matchDegree(String str, String regex) {
        List<String> matchStrs = matchParts(str, regex);
        if (CollectionUtils.isEmpty(matchStrs)) {
            return 0d;
        }
        int originLen = str.length();
        int matchLen = StringUtils.join(matchStrs).length();
        return originLen / matchLen;
